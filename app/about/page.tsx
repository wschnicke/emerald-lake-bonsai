        ...
        <div>
          ...
          >
            ...
            <p className="text-gray-700 mb-4 leading-relaxed">
              Emerald Lake Garden is the bonsai practice of Will Schnicke,
          ...
          >
            ...
            <p className="text-gray-700 mb-4 leading-relaxed">
              Emerald Lake Garden is a full-service (though part-time!) bonsai
              garden with a focus on collaborative work and education. Whether
              you need an extra pair of hands or a guide, a demo or workshop, I
              would love to help.
            </p>
            <ul className="list-disc list-inside space-y-2 text-gray-700">
              ...
              <li>
                Corporate and club events: demos, workshops, display rental
              </li>
          ...
          >
            ...
            <p className="text-gray-700 mb-4 leading-relaxed">
              Will is a bonsai student and hobbyist whose obsession has grown
              over the last 4 years. In 2025, he was the intern at Pacific
              Bonsai Museum. Will’s bonsai interests include contemporary
              display, mixed media, and conceptual bonsai art. He still doesn’t
              know how to answer the question “why did you get in to bonsai?”
              but has a plethora of answers for why he’s stayed.
            </p>
          </ContentBlock>
        </div>
      </Container>
